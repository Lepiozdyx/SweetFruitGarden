...
struct PlantDetailRemoveScreen: View {
    var body: some View {
        ZStack(alignment: .top) {
            ...
            ScrollView(showsIndicators: false) {
                VStack(spacing: 16) {
                    ...
                    infoCard(
                        title: "Harvest",
                        text: "In 3–5 years after planting. Pick: August–September.",
                        iconAsset: "Icon-3",
                        minHeight: 91.19
                    )
                    ...
                    infoCard(
                        title: "Requirements",
                        text: "Full sun, loamy soil, frost resistance −30°C",
                        iconAsset: "Icon-4",
                        minHeight: 71.59
                    )
                    ...
                    infoCard(
                        title: "Care Tips",
                        text: "Water deeply once a week. Prune in early spring. Feed with compost each season.",
                        iconAsset: "Icon-5",
                        minHeight: 110.78
                    )
                }
    ...
    private var quickFacts: some View {
        HStack(spacing: 0) {
            ...
            divider
            quickFactColumn(value: "Autumn", label: "Season")
            divider
            quickFactColumn(value: "3–5\nyears after\nplanting", label: "Harvest")
        }
        .frame(height: 132)
